...
public class CodeGenerator {
    ...
    public static final String DB_URL = "jdbc:mysql://localhost:3306/invoiving_dev?useUnicode=true&characterEncoding=utf8&allowMultiQueries=true";
    public static final String USER_NAME = "root";
    public static final String PASSWORD = "123456";
    public static final String DRIVER = "com.mysql.jdbc.Driver";
    public static final String AUTHOR = "小混蛋";
    //生成的文件输出到哪个目录
